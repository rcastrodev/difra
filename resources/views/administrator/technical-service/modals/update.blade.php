<div class="modal fade" id="modal-update-element">
    <form action="{{ route('technical-service.content.generic-section.update') }}" method="post" id="form-update-slider" class="modal-dialog" data-asyn="no" enctype="multipart/form-data">
        @csrf
